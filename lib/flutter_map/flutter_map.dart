...
export 'src/gestures/interactive_flag.dart';
export 'src/gestures/map_events.dart';
export 'src/gestures/multi_finger_gesture.dart';
...
export 'src/layer/tile_builder/tile_builder.dart';
export 'src/layer/tile_layer.dart';
export 'src/layer/tile_provider/file_tile_provider_io.dart'
    if (dart.library.html) 'src/layer/tile_provider/file_tile_provider_web.dart';
export 'src/layer/tile_provider/tile_provider.dart';
...
class MapOptions {
  ...
  MapOptions({
    ...
    assert(slideOnBoundaries ||
        !isOutOfBounds(this.center)); //You cannot start outside pan boundary
